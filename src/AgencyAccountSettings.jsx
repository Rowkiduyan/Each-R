                                ...
                                <div className="flex-1 space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#800000] focus:border-[#800000] text-sm"
                                        />
                                    ...
                                    <div className="flex gap-3">
                                        <button
                                            ...
                                            className="px-6 py-2 bg-[#800000] text-white rounded-lg hover:bg-[#990000] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed font-medium flex items-center gap-2"
                                        >
                                            {uploadingPicture ? (
                                                <>
